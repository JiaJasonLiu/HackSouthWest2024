    ...
    <div className="About">
          <div style = {{ marginTop: '50px'}}>
            ...
            <div className='memberInfo contentLeft'>
              <p>
                <h6 className='nameLeft'>Yousuf Ahmed 
                <a href='https://github.com/yousufaahmed' target='_blank' rel="noreferrer noopener"><img src='https://img.icons8.com/?size=256&id=62856&format=png' width='20px' height='20px'></img></a>
                </h6>
            ...
            <div>
              <p className='memberInfo contentRight'>
                <h6 className='nameRight'>Will Baldwin 
                <a href='https://github.com/William-Baldwin' target='_blank' rel="noreferrer noopener"><img src='https://img.icons8.com/?size=256&id=62856&format=png' width='20px' height='20px'></img></a>
                </h6>
            ...
            <div className='memberInfo contentLeft'>
              <p>
                <h6 className='nameLeft'>Kyle Deladia 
                <a href='https://github.com/threelyK' target='_blank' rel="noreferrer noopener"><img src='https://img.icons8.com/?size=256&id=62856&format=png' width='20px' height='20px'></img></a>
                </h6>
            ...
            <div>
              <p className='memberInfo contentRight'>
                <h6 className='nameRight'>Jason Liu 
                <a href='https://github.com/JiaJasonLiu' target='_blank' rel="noreferrer noopener"><img src='https://img.icons8.com/?size=256&id=62856&format=png' width='20px' height='20px'></img></a>
                </h6>
            ...
            <div className='memberInfo contentLeft'>
              <p>
                <h6 className='nameLeft'>Dariush Tomlinson 
                <a href='https://github.com/notdari' target='_blank' rel="noreferrer noopener"><img src='https://img.icons8.com/?size=256&id=62856&format=png' width='20px' height='20px'></img></a>
                </h6>
