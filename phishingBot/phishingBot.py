														...
														<tr>
															<td class="pad">
																<div style="color:#778da9;direction:ltr;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
																	...
																	<p style="margin: 0; margin-bottom: 16px;">We're thrilled to share exciting news about our company's latest promotion – a remarkable 20% discount on stocks and shares! This unique opportunity allows investors to seize significant savings while diversifying their portfolios. </p>
                                                                    <p style="margin: 0; margin-bottom: 16px;">Whether you're a seasoned investor or just starting your investment journey, this limited-time offer provides an advantageous entry point into the financial markets.</p>
																	<p style="margin: 0; margin-bottom: 16px;">DO NOT MISS this amazing opportunity</p>
...
with open('emails.txt') as f:
        for line in f:
            ...
            html_content = MIMEText(email_template, "html")
